            ...
            while (1) {
                ...
                if (c == '}') {
                    ...
                    if (strcmp(key, "width") == 0) {
                        ...
                        if (object_type == SPH)
                            objects[counter].data.sphere.color = parse_color(json);
                        else if (object_type == PLN)
                            objects[counter].data.plane.color = parse_color(json);
                        else if (object_type == QUAD)
                            objects[counter].data.quadric.color = parse_color(json);
                        else {
